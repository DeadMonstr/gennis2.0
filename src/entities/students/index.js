...
export {fetchOnlyNewStudentsData, fetchOnlyStudyingStudentsData, fetchNewStudentsDataWithBranch, fetchStudyingStudentsDataWithBranch, fetchOnlyDeletedStudentsData} from "./model/studentsThunk"
export {
    getNewStudentsData,
    getStudyingStudents,
    getCurseLevelData,
